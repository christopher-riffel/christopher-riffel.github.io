...
function doSend() {
  ...
  fetch('/api/chat', {
    ...
    body: JSON.stringify({ messages: msgs, system: CHRIS_CONTEXT })
  })
  ...
  .catch(function() {
    doRemoveTyping();
    chatHistory.pop();
    doAddMessage('bot', 'Something went wrong. Please try again.');
  });
}
...
window.onload = function() {
  doAddMessage('bot', "Hi! I'm Ask Chris - your guide to everything about Christopher Riffel's career and story. What would you like to know?");
